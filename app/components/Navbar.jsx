...
const Navbar = () => {
  ...
  return (
    <>
      <motion.nav
        exit={{ opacity: 0 }}
        className="w-full h-10 mt-10 z-50 text-white  px-4 fixed justify-center items-center hidden md:flex"
      >
        <Link
          href="/about"
      ...
      <nav className={`md:hidden w-full p-5 z-50 text-white  px-4 fixed justify-start items-center flex flex-col gap-20  ${open&&"bg-black bg-opacity-80 backdrop-blur-sm h-screen"}`}>
        <div className="px-4 p-2  basis-0 transition-all duration-300 ease-in-out hover:text-black self-stretch bg-white backdrop-blur-sm  bg-opacity-10 border border-stone-300  justify-between items-center  gap-2.5 inline-flex">
          <Link href="/">
            <svg
            width="56"
            height="36"
        ...
        <div className={`nav-items ${open&&"nav-active "} flex w-full flex-col justify-center items-center  gap-20`}>
          <Link
            href="/about"
            className="p-10 grow  basis-0 transition-all duration-300 ease-in-out hover:text-black hover:bg-opacity-100 self-stretch bg-white backdrop-blur-sm  bg-opacity-10 border border-stone-300 flex-col justify-center items-center gap-2.5 inline-flex"
          >
            <div className="codedText text-opacity-90 text-lg font-semibold font-['Chakra Petch'] leading-tight">
              ABOUT
            </div>
          </Link>
          <Link href="/" className="p-10 grow  basis-0 transition-all duration-300 ease-in-out hover:text-black hover:bg-opacity-100 self-stretch bg-white backdrop-blur-sm  bg-opacity-10 border border-stone-300 flex-col justify-center items-center gap-2.5 inline-flex">
            <div className="codedText text-opacity-90 text-lg font-semibold font-['Chakra Petch'] leading-tight">
              NEWSLETTERS
            </div>
          </Link>
          <Link
            href="/events"
            className="p-10 grow  basis-0 transition-all duration-300 ease-in-out hover:text-black hover:bg-opacity-100 self-stretch bg-white backdrop-blur-md  bg-opacity-10 border border-stone-300 flex-col justify-center items-center gap-2.5 inline-flex"
          >
            <div className="text-opacity-90 text-lg font-semibold font-['Chakra Petch'] leading-tight">
              EVENTS
            </div>
          </Link>
          <Link
