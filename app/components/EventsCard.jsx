function EventsCard({ title, img, desc }) {
  return (
    <div className="event_card md:w-1/4 max-h-[500px] w-full relative backdrop-blur-md  overflow-hidden border border-stone-300 justify-start items-start gap-5 inline-flex flex-col">
      ...
      <div className="flex flex-col event_details transition-all duration-300 ease-in-out w-full gap-10 p-5 absolute bottom-0 bg-black backdrop-blur-md  bg-opacity-50">
        <div className="self-stretch text-white text-opacity-80  text-xl md:text-xl font-bold font-['Chakra Petch'] uppercase leading-7 tracking-widest">
          {title}
        </div>
